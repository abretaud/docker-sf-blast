...
window.onload = function(){
    ...
    def inject_link(self, db, line):
        ...
        apollo_track = "&addStores=%257B%2522url%2522%253A%257B%2522type%2522%253A%2522JBrowse%252FStore%252FSeqFeature%252FGFF3%2522%252C%2522urlTemplate%2522%253A%2522{gff_url}%2522%257D%257D"
        apollo_track += "&addTracks=%255B%257B%2522label%2522%253A%2522Blast%20results%2522%252C%2522type%2522%253A%2522JBrowse%252FView%252FTrack%252FCanvasFeatures%2522%252C%2522store%2522%253A%2522url%2522%257D%255D"
        apollo_track += "&tracks=Blast%2520results"
